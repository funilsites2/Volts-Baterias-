        ...
        <div className="grid md:grid-cols-4 gap-16 mb-24">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/5561991288864" target="_blank" aria-label="WhatsApp" className="w-12 h-12 glass bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-full flex items-center justify-center text-slate-700 dark:text-white hover:bg-blue-600 dark:hover:bg-[#00f2ff] hover:text-white dark:hover:text-[#050a15] transition-colors shadow-md dark:shadow-none">
                <Phone size={20} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex flex-col">
                ...
                <a href="https://wa.me/5561991288864" target="_blank" className="text-lg font-bold text-blue-600 dark:text-[#00f2ff] hover:underline">(61) 99128-8864</a>
              </div>
              <div className="flex flex-col">
